...
module Proxy::RemoteExecution
  module Ssh
    class << self
      ...
      # TODO: Should we require this strict naming convention for cert file
      ...
      def ca_public_key_file
        path = Plugin.settings.ssh_ca_public_key_file
      ...
      def validate_ssh_settings!
        ...
        if present?(Plugin.settings.ssh_ca_public_key_file)
